...
data_btss = list(
  ...
  "mbo_lambda1.0" = readRDS("data/BTSS/mbo_lambda1.rds"),
  "mbo_lambda2.0" = readRDS("data/BTSS/mbo_lambda2.rds"),
  "test" = readRDS("data/BTSS/randomLHS_1000.rds")
)

data_kc1 = list(
  "mbo_lambda0.5" = readRDS("data/kc1/mbo_lambda0.5.rds"),
  "mbo_lambda1.0" = readRDS("data/kc1/mbo_lambda1.rds"),
  "mbo_lambda2.0" = readRDS("data/kc1/mbo_lambda2.rds"),
