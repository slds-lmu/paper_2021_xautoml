...
ui <- fluidPage(
  ...
  sidebarLayout(
    ...
    sidebarPanel(width = 2,
      selectInput("method", "Choose Method", c("xgboost", "mlp")),
      uiOutput("dataset"),
    ...
    mainPanel(width = 9,
      ...
      tabsetPanel(
        tabPanel("Descriptive", br(),
                 ...
                 br(),
                 fluidRow(column(6, h4("Training dataset")), column(6, h4("Test dataset"))),
        ...
        tabPanel("Local Interpretations", br(),
                 ...
                 br(),
                 fluidRow(column(6, uiOutput("obs1")), column(6, uiOutput("obs2"))),
                 br(),
                 fluidRow(column(6, h4("LIME"))), 
                 fluidRow(column(6, plotlyOutput("lime.best") %>% withSpinner(color = "#0dc5c1")), column(6, plotlyOutput("lime.worst"))),
                 br(),
